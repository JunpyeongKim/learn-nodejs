...
var write = function (contents) {
	...
	$.post('/sns/write', postdata, function() {
		load();
	});
};
...
var modify = function (contents, id) {
	...
	$.post('/sns/modify', postdata, function() {
		load();
	});
};
...
var comment = function (comment, id) {
	...
	$.post('/sns/comment', postdata, function() {
		load();
	});
};
...
var del = function (id) {
	...
	$.post('/sns/del', postdata, function() {
		load();
	});
};
...
var like = function (id) {
	...
	$.post('/sns/like', postdata, function() {
		load();
	});
};
